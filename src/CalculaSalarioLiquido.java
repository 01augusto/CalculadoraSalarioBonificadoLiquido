...
public class CalculaSalarioLiquido {
    public static void main(String[] args) {
        ...
        // Aplique as regras de desconto de impostos
        double imposto = 0;
        ...
        // Calcule o salário líquido considerando o bônus e o desconto de imposto
        double salarioLiquido = salarioBruto + bonus - imposto;

        // Imprima o salário bruto, o bônus recebido, o imposto descontado e o salário líquido
